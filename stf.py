...
bot_token = '7568740151:AAG6hg39HWHKjxalaohS_WYTF8kH6KVOcqo'
bot = telebot.TeleBot(bot_token)
user_data = {}
allowed_users = ['1720037086']
admin_id = '1720037086'
subscription_data = {}
...
btn_one_year = telebot.types.InlineKeyboardButton(' سنة', callback_data='duration_1_year')
...
def start(message):
    ...
    if user_id in allowed_users:
        ...
        bot.reply_to(message, 'welcome to the Spam Mail bot                                                       ', reply_markup=keyboard)
    else:
        bot.reply_to(message, 'للاشتراك راسل مطور البوت @aimNmr2                                             - ')
...
def show_admin_commands(message):
    if message.from_user.id == 1720037086:  # تم تعديل هذا السطر
